#source: https://www.kaggle.com/hanjoonchoe/cnn-time-series-forecasting-with-pytorch
...
import os
for dirname, _, filenames in os.walk('/home/matej/PycharmProjects/DP_code/data'):
